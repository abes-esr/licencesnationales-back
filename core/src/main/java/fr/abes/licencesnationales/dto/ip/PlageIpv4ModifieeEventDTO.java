...
@AllArgsConstructor
@NoArgsConstructor
public class PlageIpv4ModifieeEventDTO extends IpModifieeEventDTO {
    ...
    public PlageIpv4ModifieeEventDTO(String siren, String id, String ip, String validee, String typeIp, String typeAcces, String commentaires) {
