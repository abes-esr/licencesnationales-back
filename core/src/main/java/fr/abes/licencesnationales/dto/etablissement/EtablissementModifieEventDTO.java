...
@Getter
@NoArgsConstructor
public class EtablissementModifieEventDTO {
    ...
    public EtablissementModifieEventDTO(String siren, String nomContact, String prenomContact, String mailContact, String telephoneContact, String adresseContact, String boitePostaleContact, String codePostalContact, String villeContact, String cedexContact) {
        this.siren = siren;
