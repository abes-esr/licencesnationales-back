...
@AllArgsConstructor
@NoArgsConstructor
public class Ipv4ModifieeEventDTO extends IpModifieeEventDTO {
    ...
    public Ipv4ModifieeEventDTO(String siren, String id, String ip, String validee, String typeIp, String typeAcces, String commentaires) {
