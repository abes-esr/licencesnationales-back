package fr.abes.licencesnationales.constant;
...
public class Constant implements Serializable {
    ...
    public static final String ERROR_AUTHENTICATION_IN_SECURITY_CONTEXT = "Could not set user authentication in fr.abes.licencesnationales.security context";
