...
public class Constant implements Serializable {
    ...
    public static final String ERROR_ETAB_INCONNU = "Etablissement absent de la base. Pour toute question sur la gestion des comptes, contacter le <a href='https://assistance.stp.abes.fr/servicedesk/customer/portals' target='_blank'>guichet d’assistance</a>";
    public static final String ERROR_IP_INCONNUE = "IP inconnue : ";
    public static final String ERROR_EDITEUR_INCONNU = "Editeur inconnu : ";
    public static final String ERROR_DOUBLON_MAIL = "L'adresse mail renseignée est déjà présente dans la base. Pour toute question sur la gestion des comptes, contacter le <a href='https://assistance.stp.abes.fr/servicedesk/customer/portals' target='_blank'>guichet d’assistance</a>";
    ...
    public static final String SIREN_DOUBLON = "Cet établissement dispose déjà d’un compte. Pour toute question sur la gestion des comptes, contacter le <a href='https://assistance.stp.abes.fr/servicedesk/customer/portals' target='_blank'>guichet d’assistance</a>";
     ...
     **/
    public static final String ERROR_ETAB_DOUBLON = "Cet établissement dispose déjà d’un compte. Pour toute question sur la gestion des comptes, contacter le <a href='https://assistance.stp.abes.fr/servicedesk/customer/portals' target='_blank'>guichet d’assistance</a>";
    public static final String ERROR_IP_DOUBLON = "L’adresse / la plage %s est déjà déclarée. Pour toute question sur la gestion des IP, contacter l’Abes via le <a href='https://assistance.stp.abes.fr/servicedesk/customer/portals' target='_blank'>guichet d’assistance</a> ";
