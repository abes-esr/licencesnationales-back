...
@SpringBootTest(classes = {ExportEditeurNewAccess.class, ObjectMapper.class, ExportConverter.class, UtilsMapper.class})
public class ExportEditeurNewAccessTest {
    @Autowired
    private ExportEditeurNewAccess service;
    ...
    void testExportEditeurNewAccess() {
        ...
        Assertions.assertEquals(2, result.get(0).getListeAcces().size());
